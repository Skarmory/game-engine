...
void VisibilitySystem::update(void)
{
	...
	Sight* sight  = Environment::get().get_entity_manager()->get_player()->get_component<Sight>();
	Location* loc = Environment::get().get_entity_manager()->get_player()->get_component<Location>();
