...
unique_ptr<Entity> EntityFactory::create_player(int id)
{
	...
	e->add_component(make_shared<Graphic>('@', Color::White, Color::Transparent, DrawLayer::CREATURE));
...
unique_ptr<Entity> EntityFactory::create_fire(int id)
{
	unique_ptr<Entity> e(new Entity(id));
	e->add_component(make_shared<Location>());
	e->add_component(make_shared<Graphic>('F', Color::Red, Color::Yellow, DrawLayer::EFFECT));
	e->add_component(make_shared<Collision>());
...
unique_ptr<Entity> EntityFactory::create_damage(int id)
{
	unique_ptr<Entity> e(new Entity(id));
	e->add_component(make_shared<Location>());
	e->add_component(make_shared<Graphic>('.', Color::Transparent, Color::Yellow, DrawLayer::DAMAGE_EFFECT));
	e->add_component(make_shared<Collision>());
...
unique_ptr<Entity> EntityFactory::create_aoe_dmg(int id)
{
	...
	e->add_component(make_shared<Location>());
	e->add_component(make_shared<Graphic>('.', Color::Transparent, Color::Cyan, DrawLayer::DAMAGE_EFFECT));
	e->add_component(make_shared<Collision>());
