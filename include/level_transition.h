...
{
	explicit LevelTransition(void) : next_level_name(string("")), next_level_x(-1), next_level_y(-1), next_level_z(-1) {}
	explicit LevelTransition(string& next_level_name, int next_level_x, int next_level_y, int next_level_z) 
